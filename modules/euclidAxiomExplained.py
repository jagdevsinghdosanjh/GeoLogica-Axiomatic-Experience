...
def display_axioms_explanation():
    ...
    euclid_axioms = [
        {
            "title": "Axiom 1: Things which are equal to the same thing are equal to one another",
            "description": (
        ...
        {
            "title": "Axiom 2: If equals are added to equals, the wholes are equal",
            "description": (
        ...
        {
            "title": "Axiom 3: If equals are subtracted from equals, the remainders are equal",
            "description": (
        ...
        {
            "title": "Axiom 4: Things which coincide with one another are equal to one another",
            "description": (
        ...
        {
            "title": "Axiom 5: The whole is greater than the part",
            "description": (
